...
/* ---------- TESTS ---------- */
    ...
    public function testConnectAndPrivileguedBind() {
        if (!$this->ldapcfg) {
            ...
            $ldap = Net_LDAP::connect($lcfg);
            $this->assertInstanceOf('Net_LDAP_Error', $ldap, 'Connect succeeded but was supposed to fail!');
    ...
    public function testConnectAndAnonymousBind() {
        if (!$this->ldapcfg) {
            ...
            $ldap = Net_LDAP::connect($lcfg);
            $this->assertInstanceOf('Net_LDAP', $ldap, 'Connect failed but was supposed to work. Check address and if server supports anonymous bind. If those are correct, file a bug!');
        } else {
    ...
    public function testAdd() {
        if (!$this->ldapcfg) {
            ...
            $this->assertInstanceOf('Net_LDAP_Entry', $fresh_entry);
    ...
    public function testDelete() {
        if (!$this->ldapcfg) {
            ...
            $this->assertInstanceOf('Net_LDAP_Error', $ldap->delete(1234));
            $this->assertInstanceOf('Net_LDAP_Error', $ldap->delete($ldap));
            ...
            $this->assertInstanceOf('Net_LDAP_Error', $ldap->delete(
                'cn=not_existent,ou=test1,'.$testdn));

            // Try to delete main test ou without recursive set (fails too)
            $this->assertInstanceOf('Net_LDAP_Error', $ldap->delete($testdn));
    ...
    public function testModify() {
        if (!$this->ldapcfg) {
            ...
            $this->assertInstanceOf('Net_LDAP_Entry', $actual_entry);
    ...
    public function testSearch() {
        if (!$this->ldapcfg) {
            ...
            $this->assertInstanceOf('Net_LDAP_Search', $res);
            ...
            $this->assertInstanceOf('Net_LDAP_Filter', $filtero);
            ...
            $this->assertInstanceOf('Net_LDAP_Error', $res);
    ...
    public function testGetEntry() {
        if (!$this->ldapcfg) {
            ...
            // existing DN
            $this->assertInstanceOf('Net_LDAP_Entry', $ldap->getEntry($dn), "$dn was supposed to be found. Please check your ldapconfig.ini!");

            // Not existing DN
            $this->assertInstanceOf('Net_LDAP_Error',
    ...
    public function testMove() {
        if (!$this->ldapcfg) {
            ...
            // Try to move over an existing entry
             $this->assertInstanceOf('Net_LDAP_Error', $ldap->move($ou_2, $ou_3->dn(), $ldap2));
    ...
    public function testCopy() {
        if (!$this->ldapcfg) {
            ...
            $this->assertInstanceOf('Net_LDAP_Entry', $entrycp);
            ...
            $this->assertInstanceOf('Net_LDAP_Error', $entrycp_f);
    ...
    public function testRootDse() {
        if (!$this->ldapcfg) {
            ...
            $ldap =& $this->connect();
            $this->assertInstanceOf('Net_LDAP_RootDSE', $ldap->rootDSE());
        }
    }
    ...
    public function testSchema() {
        if (!$this->ldapcfg) {
            ...
            $ldap =& $this->connect();
            $this->assertInstanceOf('Net_LDAP_Schema', $ldap->schema());
        }
    }
    ...
    public function testUtf8Encode() {
        if (!$this->ldapcfg) {
            ...
            // wrong parameter
            $this->assertInstanceOf('Net_LDAP_Error', $ldap->utf8Encode('foobar'));
            $this->assertInstanceOf('Net_LDAP_Error', $ldap->utf8Encode(array('foobar')));
        }
    }
    ...
    public function testUtf8Decode() {
        if (!$this->ldapcfg) {
            ...
            $this->assertInstanceOf('Net_LDAP_Entry', $entry, 'Unable to fetch test entry, check ldapconfig.ini');
            ...
            // wrong parameter
            $this->assertInstanceOf('Net_LDAP_Error', $ldap->utf8Decode('foobar'));
            $this->assertInstanceOf('Net_LDAP_Error', $ldap->utf8Decode(array('foobar')));
        }
    }
