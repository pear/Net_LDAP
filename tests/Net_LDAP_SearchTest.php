    ...
    */
    public function testSPLIterator() {
        if (!$this->ldapcfg) {
            ...
            */
            $search = $ldap->search(null, '(ou=Net_LDAP*)');
            $this->assertType('Net_LDAP_Search', $search);
            $this->assertEquals(2, $search->count());

            // current() is supposed to return first valid element
            $e1 = $search->current();
            $this->assertType('Net_LDAP_Entry', $e1);
            ...
            $search->next();
            $e2 = $search->current();
            $this->assertType('Net_LDAP_Entry', $e2);
            ...
            $search->rewind();
            $e1_1 = $search->current();
            $this->assertType('Net_LDAP_Entry', $e1_1);
            ...
            $e1_2 = $search->current();
            $this->assertType('Net_LDAP_Entry', $e1_2);
            ...
            $search->rewind();
            $e1_3 = $search->current();
            $this->assertType('Net_LDAP_Entry', $e1_3);
            ...
            */
            $search = $ldap->search(null, '(ou=Net_LDAPTest_NotExistentEntry)');
            $this->assertType('Net_LDAP_Search', $search);
            ...
            */
            $search2 = $ldap->search(null, '(ou=Net_LDAP*)');
            $this->assertType('Net_LDAP_Search', $search2);
